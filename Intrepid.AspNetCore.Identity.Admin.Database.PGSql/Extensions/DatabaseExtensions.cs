...
namespace Intrepid.AspNetCore.Identity.Admin.Database.PGSql.Extensions
{
    public static class DatabaseExtensions
    {
...

        {
            ...
            services.AddDbContextPool<TIdentityDbContext>(options => options.UseNpgsql(identityConnectionString, sql => sql.MigrationsAssembly(migrationsAssembly)));
        }
